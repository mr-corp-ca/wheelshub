...
function MyCarListingDetailDirectSaleWithoutVerification() {
  const review = [
    {
      name: "Engine",
    },
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div className="flex  flex-col">
            ...
            <div className="flex items-center flex-row gap-2 md:gap-x-2 pt-6">
              ...
              <div className="flex  items-center font-poppins text-xs lg:text-lg">
                <p
                  onClick={() => navigate(-1)}
          ...
          <div>
            <button
              onClick={() => {
                navigate("/customer/payment-process-mycar-listing");
              }}
              className="w-[132px] h-[44px] flex items-center justify-center  rounded-xl bg-custom-blue text-white text-sm font-semibold font-inter shadow-2xl shadow-custom-blue"
            >
              Edit
            </button>
          </div>
            ...
            <div className="border rounded-xl p-5 shadow-css">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <p
                    ...
                    className="text-[9px] lg:text-lg font-medium font-Work-sans text-[#FFB543]"
                  >
              ...
              <div className="flex items-center justify-center my-14">
                <button
                  ...
                  className=" h-[44px] md:h-[52px] px-[24px] py-[12px] md:py-[13.5px] rounded-lg text-sm md:text-lg font-medium font-Work-sans border border-custom-blue text-custom-blue flex items-center justify-center "
                >
                ...
                <div className=" ">
                  <div className=" flex flex-col gap-5 my-5">
                    <div className=" flex items-center justify-between">
                      <h1 className=" text-[10px] lg:text-lg font-normal font-Work-sans text-gray-2">
                        Transaction date
                      </h1>
                      <h1 className=" text-[10px] lg:text-xl font-semibold font-plus-jakarta-sans text-gray-1">
...
export default MyCarListingDetailDirectSaleWithoutVerification;
