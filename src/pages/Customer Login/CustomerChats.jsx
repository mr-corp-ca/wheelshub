    ...
    <>
      <Layout active={"Chats"}>
        <div className="chatsMainPart">
          ...
          <div className="ChatWholepart my-5 max-w-[1260px]">
              ...
              <div className="upersection grid grid-cols-12">
                <div className="leftuper p-3 flex justify-between col-span-12 lg:col-span-4 items-center border-r border-b">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h1 className="text-sm md:text-base font-medium font-public-sans text-gray-1">
                        Robert Fox
                      </h1>
                      <h1 className="text-xs md:text-sm font-normal font-public-sans text-[#999999]">
                        Online
                      </h1>
                    </div>
                  </div>
                  ...
                  <div className="leftdown p-3 flex justify-between items-center bg-[#f2f2f2] border-b">
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className=" w-full">
                        <div>
                          <h1 className="text-sm md:text-base font-medium font-poppins text-gray-1">
                            Jimmy
                          </h1>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            <Svgs.GrayDoubleTick />
                            <h1 className="text-xs md:text-base font-normal font-public-sans text-gray-2">
                              Hey! I just checked your...
                            </h1>
                          </div>
                          <div>
                            <h1 className="text-xs md:text-sm font-normal font-public-sans text-gray-4">
                              10.44
                            </h1>
                          </div>
                        </div>
                ...
                <div className="rightdownsection col-span-12 lg:col-span-8 p-4">
                  ...
                  <div>
                    <div className="chat1right">
                      ...
                      <div className="flex items-center justify-end">
                        <span className="block text-xs md:text-sm font-normal font-public-sans text-[#b4b4b4] py-2">
                          05.21
                        </span>
                      </div>
                    </div>
                    <div className="chat1left inline-block py-10">
                      <div className="flex items-center gap-3">
                        <img src={man1} alt="" />
                        <h1 className="bg-[#f8f8f8] text-sm md:text-base font-normal font-public-sans text-gray-1 h-[44px] p-4 rounded-r-xl rounded-tl-xl flex items-center">
                          Oh great! I would like to know more
                        </h1>
                      </div>
                    ...
                    <div className="chat1right pb-10">
                      <div className="flex items-center justify-end">
                        <h1 className="text-sm md:text-base font-normal font-public-sans py-[12px] px-[16px] bg-custom-blue text-white rounded-l-xl flex items-center rounded-tr-xl w-fit">
                          Sure, Let me explain all interest prices for
                          difference type of cars.
                        </h1>
                      </div>
                      <div className="flex items-center justify-end">
                        <span className="block text-xs md:text-sm font-normal font-public-sans text-[#b4b4b4] py-2">
                  ...
                  <div className="rounded-2xl border bg-[#f8f8f8] py-5 px-5 flex items-center justify-between h-[72px]">
                    <input
                      className="text-sm md:text-base font-normal font-poppins text-gray-4 bg-transparent w-full h-full border-none outline-none"
