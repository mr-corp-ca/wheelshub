  ...
  return (
    ...
    <Layout active={'My Car listings'}>
      ...
      <div className='flex items-center gap-2 md:gap-x-2 '>
        ...
        <div className='flex items-center font-poppins text-[10px] lg:text-lg'>
          <p onClick={() => navigate(-1)} className='text-gray-1 font-medium hover:cursor-pointer hover:text-black'>My car listings/Merc...../</p>
          <p className=' font-semibold text-custom-blue'>Mechanic verification</p>
        </div>
      </div>
        </div>
      </div>
      <div className='grid grid-cols-1 lg:grid-cols-12 py-5 gap-3'>   
        ...
        <div className='border rounded-xl p-5 flex items-center gap-5 flex-wrap'>
            ...
            <div className="images flex items-center justify-center gap-x-1 lg:gap-x-4 2xl:gap-x-7 py-5">
              <span
        ...
        <div className='rightpart col-span-6 lg:col-span-5'>
            ...
            <div className='reviewWrite border rounded-xl p-5 my-5'>
                <p className=' text-sm lg:text-lg font-normal font-Work-sans text-gray-1'>
