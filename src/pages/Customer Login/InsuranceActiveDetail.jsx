...
//     <>
//     <div className=" p-10">
//       <h1 className=" text-2xl font-semibold font-inter text-gray-1">Insurance</h1>
//     </div>
//     <div className='flex flex-row items-center gap-x-2 px-10'>
...
//         <div className='topLeft  col-span-5 '>
//             <div className='topLeft1 border rounded-xl p-5 h-fit'>
//             <div>
//                 <h1 className=' text-2xl font-semibold font-inter text-gray-1'>Insurance details</h1>
//             </div>
//             <div className=' flex items-center justify-between pt-5'>
//             <div className='left flex flex-col gap-5'>
//                 <div className='flex items-center gap-5'>
//                     <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>Insurance agent</h1>
//                     <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>LB Insurance</h1>
//                 </div>
//                 <div className='flex items-center gap-5'>
//                 <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>Start date</h1>
//                 <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>02-7-2024</h1>
//                 </div>
//                 <div className='flex items-center gap-5'>
//                 <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>Customer</h1>
//                 <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>Jack</h1>
//                 </div>
//             </div>
//             <div className='right flex flex-col gap-5'>
//                 <div className='flex items-center gap-5'>
//                 <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>Insurance price</h1>
//                 <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>$3600</h1>
//                 </div>
//                 <div className='flex items-center gap-5'>
//                 <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>End date</h1>
//                 <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>01-7-2025</h1>
//                 </div>
//                 <div className='flex items-center gap-5'>
//                 <h1 className=' text-lg font-normal font-Work-sans text-gray-4'>Rep. name</h1>
//                 <h1 className=' text-lg font-medium font-Work-sans text-gray-1'>John</h1>
//                 </div>
//             </div>
//             </div>
//             </div>
          
//             <div className='centerLeft border rounded-xl p-5 col-span-5 my-7'>
//         <div>
//             <h1 className=' text-2xl font-semibold font-inter text-gray-1'>Documents</h1>
//         </div>
//         <div className='pt-10 flex items-center gap-6'>
//             <div className='flex flex-col items-center gap-2'>
//                 <div className='border rounded-xl w-fit  p-5 flex items-center justify-center flex-col gap-5 shadow-sm'>
//                 <img src={documentIcon} alt="" />
//                 <button className='px-[20px] py-[10px] border border-gray-1 rounded-xl text-base font-medium font-Work-sans text-gray-1'>Download</button>
//                 </div>
//                 <div>
//                     <h1 className=' text-base font-medium font-Work-sans text-gray-1'>
//                     Registration form
//                     </h1>
//                 </div>
//             </div>
...
//         </div>
//         </div>
//         <div className='bottomleft border rounded-xl p-5 bg-[#f0f4fe]'>
//             <div className='w-[50%] flex items-center flex-col justify-center mx-auto gap-5'>
//             <div>
...
//                 Are you sure all the documents are
//                 information is correct? 
//                 </h1>
//             </div>
//             <div>
//                 <button className=' px-[16px] py-[12px] rounded-xl bg-custom-blue text-white text-sm font-semibold font-inter'>Verify now</button>
//             </div>
//             </div>
...
//         <div className='topRight border rounded-xl p-5 py-10 col-span-5'>
//             <div>
...
//                 <div>
//                     <h1 className=' text-lg font-medium font-Work-sans text-gray-4'>Insurance policy date</h1>
//                 </div>
//                 <div>
//                     <h1 className=' text-2xl font-semibold font-inter text-gray-1'>
//                     14-07-2024, 11:00 AM
...
//                         <h1  className=' text-2xl font-semibold font-inter text-gray-1'>LB Insurance point</h1>
...
function InsuranceActiveDetail() {
  ...
  return (
    <>
      ...
      <div className='flex flex-wrap items-center gap-2 md:gap-x-2 px-3'>
        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex flex-col md:flex-row font-poppins font-normal text-base'>
          <p onClick={() => navigate(-1)} className='text-gray-1 hover:cursor-pointer hover:text-black'>Insurance/</p>
          <p onClick={() => navigate(-1)} className='text-gray-1 hover:cursor-pointer hover:text-black'>Insurance verification/</p>
          <p className='font-semibold text-custom-blue'>Mercedes-Benz E 220 D</p>
        </div>
      </div>
      <div className='p-3'>
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-3'>
          <div className='col-span-1 lg:col-span-7'>
            <div className='border rounded-xl p-5 h-fit'>
              <div>
                <h1 className='text-xl md:text-2xl font-semibold font-inter text-gray-1'>Insurance Policy details</h1>
              </div>
            ...
            <div className='border rounded-xl p-5 col-span-1 lg:col-span-5 my-7'>
              ...
              <div className='pt-10 flex flex-col md:flex-row items-center gap-6 flex-wrap'>
                <div className='flex flex-col items-center gap-2'>
                  <div className='border rounded-xl w-fit p-5 flex items-center justify-center flex-col gap-5 shadow-sm'>
                    <img src={documentIcon} alt="" />
                    <button className='px-5 py-2 border border-gray-1 rounded-xl text-base font-medium font-Work-sans text-gray-1'>Download</button>
                  </div>
                  <div>
            ...
            {/* <div className='border rounded-xl p-5 bg-[#f0f4fe]'>
              <div className='w-full md:w-[50%] flex items-center flex-col justify-center mx-auto gap-5'>
                ...
                <div>
                  <button onClick={handleShowPopup} className='w-[136px] h-[48px] px-4 py-2 rounded-xl bg-custom-blue text-white text-sm font-semibold font-inter'>Verify now</button>
          ...
          <div className='border rounded-xl p-5 py-10 col-span-1 lg:col-span-5'>
            <div>
              <h1 className='text-2xl md:text-[32px] font-bold font-inter text-gray-1'>Insurance details</h1>
            </div>
            <div className='rounded-xl bg-[#eeeeee] p-5 my-5'>
              <div className='flex flex-col gap-4'>
                <div>
