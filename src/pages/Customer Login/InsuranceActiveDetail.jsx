...
function InsuranceActiveDetail() {
  ...
  return (
    ...
    <Layout active={'Insurance'}>
      ...
      <div className='flex items-center gap-2 md:gap-x-2 py-5'>
        ...
        <div className='flex items-center font-poppins text-[8px] lg:text-lg'>
          <p onClick={() => navigate(-1)} className='text-gray-1 font-medium hover:cursor-pointer hover:text-black'>Insurance/</p>
          <p onClick={() => navigate(-1)} className='text-gray-1 font-medium hover:cursor-pointer hover:text-black'>Insurance verification/</p>
              ...
              <div className='flex flex-col md:flex-row items-center justify-between pt-5 gap-5 md:gap-5'>
                <div className='flex flex-col gap-5 w-full lg:w-[50%] '>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>Insurance agent</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>LB Insurance</h1>
                  </div>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>Start date</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>02-7-2024</h1>
                  </div>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>Customer</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>Jack</h1>
                  </div>
                </div>
                <div className='flex flex-col gap-5 w-full lg:w-[50%]'>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>Insurance price</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>$3600</h1>
                  </div>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>End date</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>01-7-2025</h1>
                  </div>
                  <div className='flex items-center justify-between gap-2'>
                    <h1 className='text-sm md:text-lg font-normal font-Work-sans text-gray-4'>Rep. name</h1>
                    <h1 className='text-sm md:text-lg font-medium font-Work-sans text-gray-1'>John</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='border rounded-xl p-5 py-10 col-span-1 lg:col-span-5'>
            ...
            <div className='rounded-xl bg-[#eeeeee] p-5 my-5'>
              <div className='flex flex-col gap-4'>
                ...
                <div>
                  <h1 className=' md:text-2xl font-semibold font-inter text-gray-1'>14-07-2024, 11:00 AM</h1>
                </div>
                <div className='flex flex-col md:flex-row'>
                  <h1 className='text-lg font-medium font-Work-sans text-gray-4'>Address:</h1>
                  <span className=' text-sm lg:text-lg font-medium font-Work-sans text-custom-blue'>7711 128 St, Surrey, BC V3W 4E6, Canada</span>
                </div>
              </div>
            </div>
            <div>
