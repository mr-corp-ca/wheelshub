    ...
    <Layout active={'Dashboard'}>
      <div className='w-full h-screen flex items-center justify-center px-4'>
        <div className='verification border rounded-xl px-10 py-4 w-full max-w-2xl flex items-center justify-center flex-col gap-6'>
          ...
          <div>
            <Button onClick={()=>{navigate('/customer/customer-setting')}} title={"Verify now"} className={"font-Work-sans text-base sm:text-lg font-medium shadow-2xl shadow-custom-blue"} />
          </div>
        </div>
      </div>
      </Layout>
