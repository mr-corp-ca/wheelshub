...
function CustomerVerificationInProgress() {
      ...
      <div className='w-full flex items-center justify-center '>
        <div className='verificationProcess rounded-xl border p-6 sm:p-10 w-full max-w-4xl'>
          ...
          <div className='flex items-center justify-center py-3'>
            <button onClick={()=>{navigate('/customer/customer-dashboard')}} className='text-sm rounded-xl border text-gray-1 font-inter font-semibold w-[123px] h-[48px] px-[24px] py-[12px] border-gray-1 flex items-center justify-center'>
              Need help
            </button>
          </div>
        </div>
...
export default CustomerVerificationInProgress;
