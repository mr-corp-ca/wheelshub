          ...
          <div className=" flex items-center justify-center">
            <div className="  rounded-xl ">
              ...
              <div className="mt-9 text-center flex items-center justify-center">
                <button
                  onClick={handleClick}
                  className="w-[129px] h-[52px] flex items-center justify-center bg-custom-blue text-white rounded-md hover:bg-blue-600 text-lg font-medium font-Work-sans shadow-2xl shadow-custom-blue"
                >
                  Next
                </button>
              </div>
