...
<div className="w-full md:w-[80%] mx-auto bg-white border rounded-xl py-10 px-5 md:px-16 mt-10">
  <div className="payment">
    <div className="rounded-xl">
      ...
      <div className="flex items-center justify-center pb-4 md:pb-5">
        <button className="h-[44px] md:h-[52px] px-[24px] md:px-[44px] py-[12px] md:py-[15.5px] rounded-lg text-sm md:text-lg font-medium font-Work-sans bg-custom-blue text-white flex items-center justify-center shadow-2xl shadow-custom-blue">
          Proceed to pay
        </button>
      </div>
    </div>
