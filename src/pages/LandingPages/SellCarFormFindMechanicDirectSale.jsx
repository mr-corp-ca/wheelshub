...
function SellCarFormFindMechanicDirectSale() {
  ...
  return (
    ...
    <div className=" max-w-[1920px] mx-auto">
      ...
      <div className="cardpart flex justify-center bg-white">
        <div className=" mb-20 -mt-16 lg:-mt-32 w-full md:w-[90%] 2xl:max-w-[1440px] mx-auto bg-white border rounded-[16px] shadow-css py-10 px-5 md:px-16 relative">
          <div className="flex text-center items-center justify-center text-2xl md:text-[28px] font-bold font-inter text-gray-800">
            <h1>Select mechanic to check the car</h1> <button onClick={()=>{navigate('/sellyourcar/find-dealer-direct-sale')}} className="border border-gray-1 outline-none rounded-lg text-gray-2 px-2 absolute top-10 right-16 text-lg w-[71px]">Skip</button>
          </div>
...
export default SellCarFormFindMechanicDirectSale;
