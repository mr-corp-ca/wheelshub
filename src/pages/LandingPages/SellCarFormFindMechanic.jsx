...
//             </div>
//           </div>
//           <div className="hidden md:col-span-2 xl:flex items-center justify-center">
//             <img src={mechanicImage} alt="Man smiling" />
//           </div>
//         </div>

//         <div className="w-[80%] mx-auto bg-white border rounded-xl py-10 px-16">
//           <div className="flex items-center justify-center text-[28px] font-bold font-inter text-gray-1 ">
...
//               Verified
//             </button>
//             <button className=" rounded-lg bg-white border border-gray-1 text-gray-1 px-4 py-2 text-sm md:text-lg font-medium font-Work-sans flex items-center justify-center ">
//               Nearby
//             </button>
//             <button className=" rounded-lg bg-white border  border-gray-1 text-gray-1 px-4 py-2 text-sm md:text-lg font-medium font-Work-sans flex items-center justify-center ">
//               Most viewed
...
//             <button className=" h-[44px] md:h-[48px] px-[24px] py-[12px] md:py-[13.5px] rounded-lg text-sm md:text-lg font-medium font-Work-sans flex items-center justify-center border border-gray-1 text-gray-1">
//               Load more
//             </button>
//           </div>
//           <div className=" flex items-center justify-center gap-5">
//             <img src={checkboxpng} alt="" />
//             <p className=" text-lg font-normal font-inter text-gray-1 ">
//               I agree to pay the mechanic fee of $250 after successfull
//               verification
//             </p>
//           </div>
//           <div className="flex items-center justify-center my-10 pb-4 md:pb-5">
//             <button className="w-[129px] h-[52px] px-[44px]  py-[15.5px] rounded-lg text-sm md:text-lg font-medium font-Work-sans bg-custom-blue text-white flex items-center justify-center shadow-custom-blue shadow-2xl">
//               Next
//             </button>
//           </div>
//         </div>
