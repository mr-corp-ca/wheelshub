        ...
        <div className="overflow-x-auto">
          ...
          <div className="flex flex-wrap  min-w-max flex-row gap-6 justify-center sm:justify-start space-x-0 sm:space-x-4 mb-4">
            {tabs.map((tab) => (
              <button
                key={tab}
                className={`pb-1 mx-1 sm:mx-0  text-base font-normal font-poppins ${activeTab === tab
            ...
            <div className="pt-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="w-full text-center flex items-center justify-center">
                  <Button
                    className={"w-[190px] h-[48px] px-[16px] py-[12px] text-sm font-semibold  font-inter self-center items-center"}
                    title={"Submit"}
                  />
                </div>
              </form>
