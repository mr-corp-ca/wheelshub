...
// import crossIcon from "../../assets/images/Frame 1410115282.png"
...
//                       <div>
//                         <img src={crossIcon} onClick={onClose} className=" absolute top-10" alt="" />
//                       </div>
//           <div className=" flex items-center justify-center h-[100vh]  md:w-[40vw] w-[90%]">
//             <div className=" mx-auto bg-white rounded-lg  w-full py-7 ">
...
//                         <button className="w-[218px] h-[52px] px-[px] py-[15.5px] border border-gray-1 font-medium text-lg font-Work-sans rounded-xl flex items-center justify-center">
//                           Ask for Reschedule
//                         </button>
//                         <button className="w-[218px] h-[52px] px-[px] py-[15.5px] bg-custom-blue font-medium text-lg font-Work-sans rounded-xl text-white flex items-center justify-center">
//                           Approve request
//                         </button>
//                       </div>
//                     </div>
