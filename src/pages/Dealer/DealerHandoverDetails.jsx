        ...
        <div className="leftpart col-span-7">
          <div className="border rounded-xl p-5 flex items-center gap-5 flex-wrap">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-lg font-medium font-Work-sans text-gray-4">
                Insurance agent
              </p>
              <p className="text-lg font-medium font-Work-sans text-custom-blue">
                +1 699 656 5554
              </p>
            </div>
          </div>
                ...
                <div key={i} className="reviewbox">
                  ...
                  <div className="reviewWrite border rounded-xl p-5 my-5">
                    <p className=" text-lg font-normal font-Work-sans text-gray-1">
                      ...
                      even at higher speeds, and provides ample power for both
                      city driving and highway cruising. Maintenance has been
                      straightforward, with no significant issues reported.
                    </p>
                  </div>
                </div>
              </>
...
export default DealerHandoverDetails;
