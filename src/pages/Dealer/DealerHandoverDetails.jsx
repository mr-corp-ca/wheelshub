  ...
  return (
    <>
      ...
      <div className='grid grid-cols-11 p-10'>
        ...
        <div className="">
        <h1 className="text-base md:text-2xl font-semibold font-inter text-gray-1">Dashboard</h1>
      </div>
      <div className='flex flex-col md:flex-row gap-2 md:gap-x-2 '>
        ...
        <div className='flex flex-col md:flex-row font-poppins font-normal text-base'>
          <p onClick={() => navigate(-1)} className='text-gray-1 text-sm lg:text-base hover:cursor-pointer hover:text-black'>Car handover/</p>
