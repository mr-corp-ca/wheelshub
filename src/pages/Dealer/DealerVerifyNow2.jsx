  ...
  return (
    ...
    <div className='flex flex-row items-center gap-x-2'>
                    ...
                    <div className='flex flex-row font-poppins text-xs lg:text-lg'>
                        <p onClick={() => navigate(-1)} className='text-gray-1 font-medium hover:cursor-pointer hover:text-black'>Car verification/</p>
                        <p className='font-semibold text-custom-blue'>Mercedes-Benz E 220 D</p>
                    </div>
      </div>
    <div className=" flex lg:px-5 py-5">
    <div className="w-full lg:w-[90%]  border px-3 lg:px-0 py-8 lg:py-16 rounded-xl">
      <div className=" ">
      ...
      <div className="pt-3 w-full lg:w-[90%] mx-auto">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="w-full text-center flex items-center justify-center">
            <button
            onClick={()=>{navigate('/dealer/dealer-verify3')}}
              className={
