            ...
            <div className=" mx-auto p-10 bg-white shadow-lg rounded-xl border">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div  className=" flex items-center justify-center">
                  <button onClick={()=>{navigate('/dealer/dealer-dashboard')}} className=" text-sm font-semibold font-inter bg-custom-blue px-[16px] py-[12px] w-full rounded-xl text-white">Close</button>
                </div>
              </div>
            </div>
          </form>
