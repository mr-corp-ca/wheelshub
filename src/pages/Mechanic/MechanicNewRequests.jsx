              ...
              return (
                <div key={index} className="card border rounded-2xl flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-center pb-4 md:pb-5">
                    <button onClick={()=>{navigate('/mechanic/mechanic-chats')}} className="w-full max-w-[132px] h-[44px] md:h-[48px] px-[24px] py-[12px] md:py-[13.5px] rounded-lg text-sm md:text-lg font-medium font-Work-sans bg-custom-blue text-white flex items-center justify-center shadow-custom-blue shadow-2xl">
                      Chat now
                    </button>
                  </div>
                </div>
