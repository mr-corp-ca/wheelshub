              ...
              <div className="space-y-5">
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 pt-3">
                  <div className="w-full">
                    ...
                    {/* <Input label={"Transmission"} placeholder={"Select"} /> */}
                    <select
                      className=" text-base font-medium font-inter text-gray-1 px-[16px] py-[12.5px] rounded-xl bg-[#fafafa] w-full outline-none border focus-within:ring-2 ring-custom-blue caret-custom-blue my-2"
                      name=""
                      id=""
                    >
                      <option
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      className=" px-[16px] py-[12.5px] rounded-xl bg-[#fafafa] w-full outline-none border focus-within:ring-2 ring-custom-blue caret-custom-blue my-2"
                    />
                  </div>
                </div>
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
