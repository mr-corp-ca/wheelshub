...
function AppointmentsDetails() {
  ...
  return (
    <>
      ...
      <div className='flex flex-col md:flex-row items-center gap-2 md:gap-x-2 px-6 md:px-10'>
        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='col-span-1 lg:col-span-5'>
            ...
            <div className='border rounded-xl p-5 bg-[#f0f4fe]'>
              <div className='w-full md:w-[50%] flex items-center flex-col justify-center mx-auto gap-5'>
                ...
                <div>
                  <button className='w-[136px] h-[48px] px-4 py-2 rounded-xl bg-custom-blue text-white text-sm font-semibold font-inter'>Verify now</button>
                </div>
              </div>
            </div>
          </div>
