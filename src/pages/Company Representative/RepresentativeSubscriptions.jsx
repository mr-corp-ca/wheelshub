      ...
      <div className=" my-5">
        ...
        <div className="cards py-4 md:py-5 grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
          {[
            ...
            <div onClick={()=>{handleCardClick(index)}} key={index} className={` cursor-pointer rounded-xl p-3 relative w-full max-w-[352px] ${cardbg === index ? 'bg-custom-blue text-white shadow-2xl shadow-custom-blue' : 'bg-white text-custom-blue border'}`}>
...
export default RepresentativeSubscriptions;