      ...
      <div className="p-4 md:p-6 lg:p-8">
        ...
        <div className="mainpart grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div className="flex  flex-wrap  items-center gap-5 pb-5">
                <button onClick={()=>{hnadleClick("mechanic")}} className={` rounded-xl text-lg font-medium font-Work-sans px-[16px] py-[10px] ${(activeTab === "mechanic")? "bg-custom-blue text-white shadow-2xl shadow-custom-blue" : " bg-white text-gray-1 border border-gray-1"}`}>Mechanic</button>
                <button onClick={()=>{hnadleClick("dealer")}} className={` rounded-xl text-lg font-medium font-Work-sans px-[16px] py-[10px] ${(activeTab === "dealer")? "bg-custom-blue text-white shadow-2xl shadow-custom-blue" : " bg-white text-gray-1 border border-gray-1"}`}>Dealer</button>
                <button onClick={()=>{hnadleClick("handover")}} className={` rounded-xl text-lg font-medium font-Work-sans px-[16px] py-[10px] ${(activeTab === "handover")? "bg-custom-blue text-white shadow-2xl shadow-custom-blue" : " bg-white text-gray-1 border border-gray-1"}`}>Handover</button>
                <button onClick={()=>{hnadleClick("insurance")}} className={` rounded-xl text-lg font-medium font-Work-sans px-[16px] py-[10px] ${(activeTab === "insurance")? "bg-custom-blue text-white shadow-2xl shadow-custom-blue" : " bg-white text-gray-1 border border-gray-1"}`}>Insurance</button>
            </div>
            </div>
            {Array(4)
              .fill()
                  ...
                  <div className="card1 border p-4 md:p-5 rounded-xl flex flex-col md:flex-row justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-4">
                      <button onClick={()=>{navigate("/insuranceform1")}}  className="w-[150px] h-[44px] rounded-xl border px-2 md:px-[12px] py-2 md:py-[11.5px] text-sm md:text-lg font-medium font-Work-sans text-custom-blue border-custom-blue flex items-center justify-center">
                      Verify now
                      </button>
                    </div>
                      </div>
