     ...
     <div className="">
      ...
      <div className='flex items-center gap-2 my-5'>
        ...
        <div className='flex items-center font-poppins text-xs lg:text-lg'>
          <p onClick={() => navigate(-1)} className='text-gray-1 hover:cursor-pointer hover:text-black font-medium'>Car handover/</p>
      ...
      <div className="leftpart col-span-12  lg:col-span-6">
        ...
        <div className='rightpart border shadow-css rounded-xl p-5 py-10 col-span-12 lg:col-span-6'>
            <div>
