  ...
  return (
    <>
     <div className="">
      ...
      <div className='flex items-center flex-col md:flex-row gap-2 my-5'>
        ...
        <div className='flex flex-col md:flex-row font-poppins font-normal text-base'>
          <p onClick={() => navigate(-1)} className='text-gray-1 hover:cursor-pointer hover:text-black'>Car handover/</p>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-12  gap-6 my-10'>
        <div className='leftpart col-span-6'>
            ...
            <div className='completehandover border rounded-xl p-5 bg-[#f0f4fe]'>
              <div className='w-full md:w-[50%] flex items-center flex-col justify-center mx-auto gap-5'>
                ...
                <div>
                  <button onClick={handleShowPopup} className=' hover:bg-[#f0f4fe] hover:border hover:text-custom-blue hover:border-custom-blue w-[136px] h-[48px] px-4 py-2 rounded-xl bg-custom-blue text-white text-sm font-semibold font-inter'>Complete now</button>
        ...
        <div className='rightpart border rounded-xl p-5 py-10 col-span-6 lg:col-span-6'>
            ...
            <div>
              <div className='py-3 border-b border-dashed flex flex-col md:flex-row justify-center md:justify-start items-center gap-5'>
                <div>
                  <img src={man3img} alt="" />
                </div>
            ...
            <div className='pt-4'>
              <div className='py-3 flex flex-col md:flex-row justify-center md:justify-start items-center gap-5'>
                <div>
                  <img src={man1img} alt="" />
                </div>
                <div className='flex flex-col justify-center md:justify-start items-center md:items-start gap-3'>
            ...
            <div className=' flex items-center justify-center pt-5'>
                <button className=' hover:bg-custom-blue hover:text-white py-[15.5px] bg-white border border-custom-blue rounded-xl text-lg font-medium font-Work-sans text-custom-blue h-[52px] w-[189px] flex items-center justify-center'>View Certificate</button>
            </div>
            </div>
          </div>
      </div>
...
export default DealerDetailsCompany